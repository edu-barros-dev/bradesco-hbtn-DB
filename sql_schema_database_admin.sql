CREATE TABLE Aluno (id bigint not null, email varchar(255), matricula varchar(255), nascimento date, nomeCompleto varchar(255), curso_id bigint, endereco_id bigint, primary key (id))
